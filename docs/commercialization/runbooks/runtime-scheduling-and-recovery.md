# Runtime Scheduling and Recovery Runbook

## Scope

本 runbook 适用于 Phase 6 统一运行控制面：`DeploymentQueueTickets`、`FleetCapacityReservations`、`ImageDistributionRecords`、WorkerNode capability manifest 和 TeamLab runtime/shard。
