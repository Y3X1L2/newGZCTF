...
- `codex/league-u1-lcx` 基于最新主线 `9999e6b1` 和 lxy 候选 `2ec37d8c`，完成列表、创建/配置、队长报名、管理员审核及双队席位。默认关闭，启用 `VITE_LEAGUE_ENABLED=true` 后从“全部模块”进入 `/league`。
...
- 按用户要求暂缓准备前成员名单缺口；U2–U4 未实现。范围、验收步骤和证据边界见 [U1 交接](handoffs/2026-09-22-league-u1-lcx.md)。
