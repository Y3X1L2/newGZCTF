...
| 主题 | 现行文档 |
| --- | --- |
| 平台产品说明 | [文字稿](user-guides/platform-product-overview.md)、[Word 文档](user-guides/隐喻平台产品说明V0.1.docx)，含 5 处截图说明 |
| 平台使用手册 | [文字稿](user-guides/platform-user-manual.md)、[Word 文档](user-guides/隐喻平台使用手册V0.1.docx)，含 26 处截图说明 |
