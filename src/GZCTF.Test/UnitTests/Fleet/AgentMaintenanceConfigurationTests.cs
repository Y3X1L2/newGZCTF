...
public class AgentMaintenanceConfigurationTests
{
    ...
    public void TeamLabDataPlaneSync_PersistsEnabledStateAcrossAgentRestart()
    {
        ...
        var changed = AgentMaintenanceService.ApplyTeamLabDataPlaneConfig(teamLab, desired, "ens18");
        ...
        Assert.Equal("ens18", teamLab["FabricInterfaceName"]!.GetValue<string>());
        ...
        Assert.False(AgentMaintenanceService.ApplyTeamLabDataPlaneConfig(teamLab, desired, "ens18"));
    }
}
