...
const items: readonly {
  ...
  { type: 'linux-vm', name: 'Linux VM', description: 'Linux 虚拟机', category: '计算资产', icon: MonitorCog },
  { type: 'windows-vm', name: 'Windows VM', description: 'Windows 虚拟机', category: '计算资产', icon: Monitor },
]
