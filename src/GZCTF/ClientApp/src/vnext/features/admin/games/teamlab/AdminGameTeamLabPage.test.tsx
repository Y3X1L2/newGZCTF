...
describe('AdminGameTeamLabPage', () => {
  beforeEach(() => {
    vi.mocked(useGameTeamLab).mockReturnValue({
      ...
      topology: { id: 'topology-1', revision: 1, schemaVersion: 2, definition: { name: '企业网络', networks: [], infrastructure: [], assets: [], connections: [], observation: { flowMetadataEnabled: true, onDemandPcapEnabled: true, endpointObservation: 'optional' } }, editor: { networks: {}, assets: {}, infrastructure: {} }, createdAt: 1, updatedAt: 1 },
