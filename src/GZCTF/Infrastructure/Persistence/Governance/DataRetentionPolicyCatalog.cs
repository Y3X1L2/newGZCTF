    ...
    public DataRetentionPolicyCatalog(IOptions<DataRetentionOptions> options)
    {
        ...
        var policies = new[]
        {
            ...
            Policy("teamlab-flow-aggregate", "TeamLab", DataLifecycleMode.Aggregate,
                ...
                "delete-batched"),
            Policy("teamlab-observation", "TeamLab", DataLifecycleMode.TerminalHistory,
                value.TeamLabObservationDays, null, PartitionGrain.None, value.DeleteBatchSize,
                "delete-evidence-batched"),
            Policy("teamlab-traffic-path", "TeamLab", DataLifecycleMode.TerminalHistory,
                value.TeamLabTrafficPathDays, null, PartitionGrain.None, value.DeleteBatchSize,
                "delete-derived-path-batched"),
            Policy("teamlab-capture", "TeamLab", DataLifecycleMode.TerminalHistory,
                value.TeamLabCaptureDays, null, PartitionGrain.None, value.DeleteBatchSize,
                "expire-object-batched"),
