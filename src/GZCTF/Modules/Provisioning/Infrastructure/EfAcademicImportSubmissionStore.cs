...
public sealed class EfAcademicImportSubmissionStore(AppDbContext context)
    : IAcademicImportSubmissionStore
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            Kind = AcademicImportApplicationService.OperationKind,
