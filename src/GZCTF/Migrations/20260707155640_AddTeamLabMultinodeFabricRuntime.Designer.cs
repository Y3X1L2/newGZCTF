...
namespace GZCTF.Migrations
{
    ...
    [Migration("20260707155640_AddTeamLabMultinodeFabricRuntime")]
    partial class AddTeamLabMultinodeFabricRuntime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GZCTF.Models.Data.IRCheckpoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("IRCheckpoints");
                });

            modelBuilder.Entity("GZCTF.Models.Data.IRInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("CheckpointResults")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<byte>("EnvironmentStatus")
                        .HasColumnType("smallint");

                    b.Property<int>("ResetCount")
                        .HasColumnType("integer");

                    b.Property<string>("ShellLog")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("GZCTF.Models.Data.ScenarioInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("StageStatuses")
                        .IsRequired()
                        .HasMaxLength(4096)
                        .HasColumnType("character varying(4096)");

                    b.Property<string>("StageTimeline")
                        .IsRequired()
                        .HasMaxLength(8192)
            ...
            modelBuilder.Entity("GZCTF.Models.Data.ScoringRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GZCTF.Models.Data.Stage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("EnvironmentImageIds")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)");
                    ...
                    b.Property<string>("PrerequisiteStageIds")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)");
                    ...
                    b.HasIndex("ScenarioId", "OrderIndex");
            ...
            modelBuilder.Entity("GZCTF.Models.Data.TeamLabRuntimeAsset", b =>
                {
                    ...
                    b.HasIndex("RuntimeId", "Kind", "TopologyKey");
            ...
            modelBuilder.Entity("GZCTF.Models.Data.TeamLabRuntimeNetwork", b =>
                {
                    ...
                    b.HasIndex("RuntimeId", "TopologyKey")
                        .IsUnique();
            ...
            modelBuilder.Entity("GZCTF.Models.Data.TeamLabRuntimeShard", b =>
                {
                    ...
                    b.HasIndex("RuntimeId", "WorkerNodeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("GZCTF.Models.Data.IRInstance", b =>
                {
                    ...
                    b.HasOne("GZCTF.Models.Data.TimeSlot", "TimeSlot")
                        .WithMany()
