...
namespace GZCTF.Migrations
{
    ...
    [Migration("20260719111436_HardenPhaseNineNetworkLeaseAndCaptureBudget")]
    partial class HardenPhaseNineNetworkLeaseAndCaptureBudget
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GZCTF.Modules.Content.Domain.VmImageBuildJob", b =>
                {
                    b.Property<Guid>("OperationId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("DerivedImageTemplateId")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("RecipeDigest")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.HasIndex("DerivedImageTemplateId");

                    b.HasIndex("PreparedArtifactId");

                    b.HasIndex("WorkerNodeId");

                    b.HasIndex("SourceId", "RecipeDigest", "GuestProtocolVersion");

                    b.ToTable("VmImageBuildJobs", (string)null);
                });

            modelBuilder.Entity("GZCTF.Modules.Content.Domain.VmImageBuildSource", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("VmImageBuildSources", (string)null);
                });

            modelBuilder.Entity("GZCTF.Modules.Content.Domain.VmImageBuildSourceUploadJob", b =>
                {
                    b.Property<Guid>("OperationId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("VmImageBuildSourceUploadJobs", (string)null);
                });
            ...
            modelBuilder.Entity("GZCTF.Modules.Content.Domain.VmPreparedArtifact", b =>
                {
                    ...
                    b.Property<Guid?>("BuiltOnWorkerNodeId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BuiltOnWorkerNodeId");
                    ...
                    b.HasIndex("SourceDigest", "RecipeDigest", "PackageDigest", "GuestProtocolVersion", "OSType")
                        .IsUnique();
            ...
            modelBuilder.Entity("GZCTF.Modules.Content.Domain.VmImageBuildJob", b =>
                {
                    ...
                    b.HasOne("GZCTF.Models.Data.ImageTemplate", "DerivedImageTemplate")
                        .WithMany()
                        .HasForeignKey("DerivedImageTemplateId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("GZCTF.Modules.Audit.Domain.ApiOperation", "Operation")
                        .WithOne()
                        .HasForeignKey("GZCTF.Modules.Content.Domain.VmImageBuildJob", "OperationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GZCTF.Modules.Content.Domain.VmPreparedArtifact", "PreparedArtifact")
                        .WithMany()
                        .HasForeignKey("PreparedArtifactId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("GZCTF.Modules.Content.Domain.VmImageBuildSource", "Source")
                        .WithMany()
                        .HasForeignKey("SourceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("GZCTF.Modules.Content.Domain.VmImageBuildSourceUploadJob", b =>
                {
                    ...
                    b.HasOne("GZCTF.Modules.Audit.Domain.ApiOperation", "Operation")
                        .WithOne()
                        .HasForeignKey("GZCTF.Modules.Content.Domain.VmImageBuildSourceUploadJob", "OperationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GZCTF.Modules.Content.Domain.VmPreparedArtifact", b =>
                {
                    b.HasOne("GZCTF.Models.Data.WorkerNode", "BuiltOnWorkerNode")
                        .WithMany()
                        .HasForeignKey("BuiltOnWorkerNodeId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("BuiltOnWorkerNode");
